...
#         print('args', features['args'])
#         print('batch', features['batch']['index'])
        """Returns token_embeddings, cls_token"""
#         print('features[args] in Transformer:', features['args'])
#         print('features.keys() in Transformer:', features.keys())
#         print(len(features))
        args = features['args']
        batch = features['batch']
        features.pop('args', None)
        features.pop('batch', None)
