...
from .. import SentenceTransformerSequential
...
class SentenceLabelDataset(Dataset):
    ...
    def __init__(self, examples: List[InputExample], model: SentenceTransformerSequential, provide_positive: bool = True,
    ...
    def convert_input_examples(self, examples: List[InputExample], model: SentenceTransformerSequential):
        """
