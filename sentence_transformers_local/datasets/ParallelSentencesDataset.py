...
class ParallelSentencesDataset(Dataset):
    ...
    def __init__(self, student_model: SentenceTransformerSequential, teacher_model: SentenceTransformerSequential, batch_size: int = 8, use_embedding_cache: bool = True):
        """
